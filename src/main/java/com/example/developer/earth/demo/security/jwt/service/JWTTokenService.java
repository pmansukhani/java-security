...
public class JWTTokenService implements Clock, TokenService {
	...
	JWTTokenService(@Value("${jwt.issuer:madness}") final String issuer,
			@Value("${jwt.expiration-sec:30}") final int expirationSec,
			@Value("${jwt.clock-skew-sec:10}") final int clockSkewSec,
